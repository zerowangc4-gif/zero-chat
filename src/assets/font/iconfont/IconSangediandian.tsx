...
let IconSangediandian: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconSangediandian.defaultProps = {
  size: 20,
};

IconSangediandian = React.memo ? React.memo(IconSangediandian) : IconSangediandian;

export default IconSangediandian;
