...
let IconIconEyeCloseCopy: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      <Path
        ...
        fill={getIconColor(color, 0, '#95a4b9')}
      />
      <Path
        ...
        fill={getIconColor(color, 1, '#95a4b9')}
      />
    </Svg>
  );
};

IconIconEyeCloseCopy.defaultProps = {
  size: 20,
};

IconIconEyeCloseCopy = React.memo ? React.memo(IconIconEyeCloseCopy) : IconIconEyeCloseCopy;

export default IconIconEyeCloseCopy;
