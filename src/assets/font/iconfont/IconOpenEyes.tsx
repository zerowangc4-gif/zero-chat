...
let IconOpenEyes: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconOpenEyes.defaultProps = {
  size: 20,
};

IconOpenEyes = React.memo ? React.memo(IconOpenEyes) : IconOpenEyes;

export default IconOpenEyes;
