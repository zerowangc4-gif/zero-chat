...
export const Typography = styled.Text.attrs({
  ...
  font-family: ${({ theme, type = "body" }) => theme.presets.Text[type].fontFamily};
  font-size: ${({ theme, type = "body" }) => theme.presets.Text[type].fontSize}px;
  font-weight: ${({ theme, type = "body" }) => theme.presets.Text[type].fontWeight};
  line-height: ${({ theme, type = "body" }) => theme.presets.Text[type].lineHeight}px;

  ${({ theme, type = "body" }) => {
    const style = theme.presets.Text[type];
    let extra = "";
